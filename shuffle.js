...
export async function shuffle(state, steps, seed = null, randomizeGaps = false) {
  ...
  const boardHash = state.currentBoardSlug === 'horizontal' ? 1 : state.currentBoardSlug === 'vertical' ? 2 : state.currentBoardSlug === 'classic' ? 3 : state.currentBoardSlug === 'ninelargepieces' ? 4 : 0;
